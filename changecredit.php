...
<body style="background-color:f3f3f3;"> 
  ...
  <div class="header-right">
    ...
    <a class="logout" href="logout.php">Logout</a>
		...
		<div class="account">
		<h1 >Change Credit Card </h1></div>
			<hr width="70%";padding=0;>
	<form  name="formchange" action="checkcredit.php" method="POST" id="change" class="form-horizontal" 
      ...
      <fieldset>
        ...
        <p>
          <div>Current credit card number : <?php echo $row2['Card_Number']?></div>
          
        </p>
		  <p>
          <label>Please enter your new credit card number here :</label>
           <input type = "credit"
				 name = "Credit" 
                 id = 'Credit'
                  />
